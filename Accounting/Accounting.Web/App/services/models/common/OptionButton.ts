...
export class OptionButtonModel {
    ...
    isDirty: () => boolean;
    constructor(name: string, id: number, selected: boolean, enabled?: boolean, iconClassName?: string, isIconButton?: boolean, showTooltip?: boolean, tooltip?: KnockoutTooltip, allowTrackChange?: boolean) {
        var self = this;
        ...
        if (self.showTooltip()) {
            if (tooltip && typeof tooltip === 'object') {
                ...
                var mytooltip: KnockoutTooltip = { title: self.name(), placement: 'bottom', trigger: 'hover' };
