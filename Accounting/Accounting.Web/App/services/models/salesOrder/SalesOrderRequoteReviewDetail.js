...
define(["require", "exports", 'durandal/system'], function(require, exports, __refSystem__) {
    ...
    */
    (function (Model) {
        var SalesOrderRequoteReviewDetail = (function () {
            function SalesOrderRequoteReviewDetail(args) {
                if (args) {
        ...
        Model.SalesOrderRequoteReviewDetail = SalesOrderRequoteReviewDetail;
