    ...
    ***********************************************/
    var TransactionSearchViewModel = (function () {
        ...
        function TransactionSearchViewModel() {
            ...
            // ###START: US25313
            self.vbHeader.reportExportOptions.getUrl = function (exp, event) {
            ...
            // ###START: US25313
            self.soHeader.reportExportOptions.getUrl = function (exp, event) {
                var deferred = $.Deferred(), promise = deferred.promise();
            ...
            // ###START: US25313
            self.tqHeader.reportExportOptions.getUrl = function (exp, event) {
                var deferred = $.Deferred(), promise = deferred.promise();
