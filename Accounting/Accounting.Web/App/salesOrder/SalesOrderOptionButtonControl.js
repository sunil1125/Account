...
define(["require", "exports", 'durandal/system', 'services/models/common/OptionButton', '../services/models/common/Enums', 'durandal/app'], function(require, exports, __refSystem__, __refOptionButton__, __refEnums__, ___app__) {
    ...
    ** </summary>
    ** <createDetails>
    ** <id>US13230</id> <by>Sankesh Poojari</by> <date>10 Nov, 2014</date>
    ** </createDetails>}
    ** <changeHistory>}
    ** <id></id> <by></by> <date></date>
    ** </changeHistory>
    */
    var SalesOrderOptionButtonControl = (function () {
        function SalesOrderOptionButtonControl(args, viewType) {
        ...
        SalesOrderOptionButtonControl.prototype.getSelectedOptions = function (args) {
            var self = this;
            if (self.isMuiltiCheck) {
        ...
        SalesOrderOptionButtonControl.prototype.getTrackChange = function () {
        ...
        SalesOrderOptionButtonControl.prototype.isDirty = function () {
            return this.getTrackChange().length ? true : false;
        };

        SalesOrderOptionButtonControl.prototype.initializeButton = function (args, viewType) {
            var self = this;
        ...
        SalesOrderOptionButtonControl.prototype.cleanup = function () {
            var self = this;

            delete self.optionList;
            delete self.optionListHV;
            delete self.optionListHV2;

            delete self.getTrackChange;
            delete self.onChangesMade;
            delete self.checkChange;
            delete self.checkMsgHide;
            delete self.defaultverticalControlSpace;
        };
        return SalesOrderOptionButtonControl;
    })();
    exports.SalesOrderOptionButtonControl = SalesOrderOptionButtonControl;
});
