...
export class SalesOrderOptionButtonControl {
   ...
   */
	...
	constructor(args: IOptionButtonControlArgs, viewType: number) {
		var self = this;
	...
	*/
	...
	public initializeButton(args: IOptionButtonControlArgs, viewType: number) {
		var self = this;
