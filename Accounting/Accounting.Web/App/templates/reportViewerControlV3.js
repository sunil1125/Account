...
******************************************************************************/
define(["require", "exports", 'services/models/common/Enums', 'durandal/system', 'templates/optionButtonControl', 'templates/dateRangeFilter', 'services/models/GridSettings/UserGridSetting', 'services/models/GridSettings/ColumnDefinition', 'services/client/UserClient', 'durandal/app', 'templates/verticalGrid'], function(require, exports, __refEnums__, __refSystem__, __refOptionButtonControl__, __refdateFilterControl__, __refUserGridSetting__, __refKoColumnDefinition__, __refUserClient__, ___app__, __refVerticalGrid__) {
    /** <summary>
    ** Report Viewer Control
    ** </summary>
    ** <createDetail>
    ** <id>US25313</id> <by>Dhaval Tamhane</by> <date>20-10-2016</date>
    ** </createDetail>
    ** <changeHistory>
    ** <id>DE24967</id> <by>Shreesha Adiga</by> <date>03-11-2016</date> <description>Show filter options if exportType is 3; Don't show the alert box on fail</description>
    ** </changeHistory>
    */
    //#region references
    ...
    /// <reference path="../../Scripts/TypeDefs/jquery.fileDownload.d.ts" />
    //#endregion
    //#region Import
    ...
    */
    ...
    var ReportExportControl = (function () {
        function ReportExportControl(exportOpt, exportGraphToPDFOption) {
            ...
            /**
            * Method to generate the report to export.
            * @param {IExportOptions} : exportOpt
            * @param {Event} : event
            */
            self.onClickGenerateReport = function (exportOpt, event) {
                ...
                if (exportOpt.exportType == 3) {
                    ...
                    if (refSystem.isFunction(self.getUrl)) {
                        var resultCalback = self.getUrl(exportOpt, event);
                        if (resultCalback && resultCalback.done) {
                            resultCalback.done(function (urlData, result) {
                                if (urlData == "No Data") {
                                    ////_app.showDialog('templates/messageBox', { title: "Alert", message: "There are no records present to be downloaded." }, 'slideDown');
                                    exportOpt.enabled(true);
                                } else {
                                    exportOpt.enabled(false);

                                    //jQuery.ajaxSettings.traditional = true;
                                    $.fileDownload('DocumentViewer/DownloadReportWithColumnName', {
                                        httpMethod: 'POST',
                                        data: urlData,
                                        dataType: 'json',
                            ...
                            if (Url == "No Data") {
                                ...
                                $.fileDownload('DocumentViewer/DownloadReport?reportURL=' + encodedUrl).done(function () {
                                    exportOpt.enabled(true);
                                }).fail(function (arg) {
                                    //_app.showDialog('templates/messageBox', { title: "Alert", message: arg }, 'slideDown');
                                    exportOpt.enabled(true);
    ...
    var ReportViewerControlV3 = (function () {
        //#endregion
        //#region Constructor
        function ReportViewerControlV3(header, grid, orientation) {
            ...
            */
            ...
            /**
            * Method to get the list of visible columns.
            * @param {any} : currentTargetElement
            * @param {string} : containerId
            */
            self.getVisibleColumns = function (gridName, currentTargetElement, containerId) {
                var reportGridDiv = $("#" + gridName + " > div")[0];

                if (!containerId)
                    containerId = "ReportControlContainer";

                if (currentTargetElement) {
                    reportGridDiv = $(currentTargetElement).closest('#' + containerId).find("#" + gridName + " > div")[0];
                }

                var gridData = ko.dataFor(reportGridDiv);
                var vislibleColumnList = ko.observableArray();
                ko.utils.arrayForEach(gridData.visibleColumns(), function (column) {
                    vislibleColumnList.push(column.field);
                });

                return vislibleColumnList();
            };
        ...
        ReportViewerControlV3.prototype.onButton1Click = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.onButton2Click = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.onButton3Click = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.configureActionButtons = function (self, header) {
        ...
        ReportViewerControlV3.prototype.getSelectedRows = function () {
            var self = this;
            var selRows = [];
        ...
        ReportViewerControlV3.prototype.getReportActions = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.getShowOrHideActionButtonOnRowSelection = function (actionButton) {
            var self = this;
        ...
        ReportViewerControlV3.prototype.onChange = function (self) {
            var reportAction = new ReportAction();
        ...
        ReportViewerControlV3.prototype.getUIGridId = function (enableSaveGrid) {
            var self = this;
            var UIGridId = "";
        ...
        ReportViewerControlV3.prototype.GetColumnSettingsFromDB = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.resetGridSelection = function (self) {
            window.kg.toggleSelection(false);
        };

        //#endregion
        //#region Lifecycle event Methods
        ReportViewerControlV3.prototype.activate = function () {
            var self = this;
        ...
        ReportViewerControlV3.prototype.compositionComplete = function () {
            var self = this;
            self.isAttachedToView(true);
            $(window).trigger('resize');
        };

        ReportViewerControlV3.prototype.deactivate = function () {
            this.isAttachedToView(false);
        };

        ReportViewerControlV3.prototype.loadinitmap = function () {
            (function ($) {
        ...
        ReportViewerControlV3.prototype.resetGridSettings = function () {
            var self = this;
            self.columnDefinition(self.defaultColumnDefinition());
        ...
        ReportViewerControlV3.prototype.configureGrid = function (self, options) {
        ...
        ReportViewerControlV3.prototype.invokeHighlight = function (searchText) {
            var self = this;
        ...
        ReportViewerControlV3.prototype.setCreatedBy = function (personName) {
            var self = this;
            self.createdBy(personName);
        };

        ReportViewerControlV3.prototype.updateSelectedDimension1Option = function (id, itemValue) {
            var self = this;
        ...
        ReportViewerControlV3.prototype.updateSelectedDimension2Option = function (id, itemValue) {
            var self = this;
        ...
        ReportViewerControlV3.prototype.ForceChange = function () {
            var self = this;
            self.onChange(self);
        };

        ReportViewerControlV3.prototype.cleanup = function (gridId) {
            var self = this;
        ...
        ReportViewerControlV3.prototype.emptyReportContainer = function () {
            var self = this;
        };
        return ReportViewerControlV3;
    })();
    exports.ReportViewerControlV3 = ReportViewerControlV3;
