    ...
    */
    var shell = (function () {
        ...
        function shell() {
            ...
            // ##START: US24389
            this.truckloadAccessorials = ko.observableArray([]);
            // ##END: US24389
            ...
            // ##END: US22956
            // ##START: US25153
            this.itemsNotIntegratedWithMas = ko.observableArray([]);
            // ##END: US25153
            ...
            // ##START: US24389
            self.subscriptionGetTruckloadAccessorials = this.app.on('GetTruckloadAccessorials').then(function (callback) {
            ...
            // ###END: US20352
            // ##START: US22956
            self.subscriptionGetUVBOwnershipList = this.app.on('GetUVBOwnershipList').then(function (callback) {
            ...
            // ##START: US25153
            self.subscriptionGetItemsNotIntegratedWithMas = this.app.on('GetItemsNotIntegratedWithMas').then(function (callback) {
            ...
            */
            ...
            self.salesOrderClient.GetTruckloadAccessorials(function (data) {
                if (data) {
            ...
            // ###END: US20352
            // ##START: US22956
            refCommon.Common.prototype.GetUVBOwnershipList(function (uvbOwnershipList) {
                if (uvbOwnershipList) {
            ...
            // ##START: US25153
            self.salesOrderClient.GetItemsNotIntegratedWithMas(function (data) {
                if (data) {
