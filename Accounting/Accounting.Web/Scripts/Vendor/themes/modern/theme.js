...
** </createDetails>
** <changeHistory>
** <id>DE25040</id> <by>Janakiram</by> <date>01-12-2016</date> <description>Checking base Url path and adding if not exists.</description>
** </changeHistory>
*/
	...
	self.renderUI = function (args) {
		...
		if (skin) {
			...
			if (skinUrl) {
				...
				// ###START: DE25040
				var checkUrl = tinymce.baseURL;
				var substring = "/Scripts/Vendor";
				if (checkUrl.indexOf(substring) == -1) {
					checkUrl = "/Scripts/Vendor";
				}

				skinUrl = checkUrl + '/skins/' + skin;
				// ###END: DE25040
			}
