...
See the Apache Version 2.0 License for specific language governing permissionscrop
...
interface JQueryStatic {
	...
	*/
	...
	number(value: string, places: number): any;
	number(value: number, places: number): any;
...
interface JQuery {
	...
	// crop, reszie and zoom
	cropzoom(imageObject: Object);

	multipleSelect(options?: any, selectedOptions?: any): JQuery;
	multipleSelect(options?: any): JQuery;
	multipleSelect(methodname?: string): string[];
}
