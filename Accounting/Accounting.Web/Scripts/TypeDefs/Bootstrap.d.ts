...
interface TypeaheadOptions {
	...
	msgNoRecordFound?: string;
	showEmptyMessage?: boolean;
	autoSelectFirstIem?: boolean;
	/**
	* Used to accelerate the source method based on the throttleTimeout value. Default to false.
	*/
	throttle?: boolean;
	/**
	* Used to throttle the source method after the given time. Default to 300.
	*/
