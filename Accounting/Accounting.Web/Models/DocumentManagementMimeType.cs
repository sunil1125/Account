...
namespace Accounting.Web.Models
{
	...
	/// </summary>
	public static class DocumentManagementMimeType
	{
		/// <summary>
		...
		public static string GetMIMETypeByFilePath(string fileName)
		{
		...
		/// <summary>
		/// Guess the MIME type related to the file extension.
		/// </summary>
		/// <param name="fileExtension">Relative filename, for instance mydoc.odt</param>
		/// <returns>MIME type, for instance </returns>
		public static string GetMIMETypeByFileExtenstion(string fileExtension)
		{
			if (fileExtension.Length > 1 && /* File with an extension */
				MIMETypesDictionary.ContainsKey(fileExtension.Remove(0, 1)))
			{
				return MIMETypesDictionary[fileExtension.Remove(0, 1)];
			}
			return "application/octet-stream";
		}
