...
namespace GooglemapsClustering.Clustering.Data.Config
{
	...
	{
		private const string SectionLocal = "kunukn.GmcSettings/Local";
		private const string SectionGlobal = "kunukn.GmcSettings/Global";
		...
		private static string Throw(string s)
		{
