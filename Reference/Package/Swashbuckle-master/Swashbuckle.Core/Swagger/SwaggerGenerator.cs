...
namespace Swashbuckle.Swagger
{
    public class SwaggerGenerator : ISwaggerProvider
    {
        ...
        public SwaggerDocument GetSwagger(string rootUrl, string apiVersion)
        {
            ...
            AccomplishCustom accomplishCustom = new AccomplishCustom();
            var swaggerDoc = new SwaggerDocument
            {
                info = info,
                //host = rootUri.Host + port,
                //Customization : It overrides the host in Request URl which comes up on the click of "Try it out" 
                //(refer summary of HostUrl() in AccomplishCustom class)        
                host = !string.IsNullOrEmpty(accomplishCustom.HostUrl()) ? accomplishCustom.HostUrl() : rootUri.Host + port,
